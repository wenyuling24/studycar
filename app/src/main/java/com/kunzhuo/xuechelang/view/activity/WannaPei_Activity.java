 ...
 * 有陪练时间
 */
public class WannaPei_Activity extends BaseActivity {

    private static final String tag = "WannaPei_Activity";
    ...
    @BindView(R.id.id_getAddressBtn)
    TextView idGetAddressBtn;
    ...
    protected int setLayoutId() {
        return R.layout.mypeilian_layout;
    }
    ...
    private void initViews() {
        context = this;
        AndroidApplication.activityList2.add(WannaPei_Activity.this);
        ...
        secondPeiPriceGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                idPeiPriceMsg.setText(bean.getPtitle() + " " + bean.getPexplain());
    ...
    @OnClick({R.id.id_peiBtn, R.id.item_back, R.id.id_getAddressBtn})
                        ...
                        if (!Telephone.equals("") && ToolsUtils.isMobileNO(Telephone)) {
                            ...
                            if (!licenseH.equals("")) {
                                if (!orderMoney.equals("")) {
                                    Resquest.addSp_ordered_Add_nT(handler2, guid.toString(), mg_address,
                                            licenseH, Telephone, Name, longitude, latitude, ID, Uid);
                                } else {
                                    ToastUtil.show(context, "请输选择正确的陪练类型");
                                }
                ...
                case Resquest.SUCCESS_MSG:
                    ...
                    try {
                        ...
                        if (Code.equals("0")) {
                            ...
                            Intent intent = new Intent(context, OrderPaySelectActivity.class);
                            intent.putExtra("orderMoney", idAfterPrice.getText().toString());
                            intent.putExtra("orderName", idPeiPriceMsg.getText().toString());
