 ...
 */
public class Peilian_Adapter extends MyBaseAdapter<Peilian_Bean> {

    private Holder mHolder;

    public Peilian_Adapter(Context mContext, List<Peilian_Bean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mHolder.idPeiMsg.setText(bean.getProDescwen());
