 ...
 */
public class VideoSecond_Adapter1 extends MyBaseAdapter<Video_Bean> {

    private Holder mHolder;

    public VideoSecond_Adapter1(Context mContext, List<Video_Bean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.video_item2, parent,
                    false);
