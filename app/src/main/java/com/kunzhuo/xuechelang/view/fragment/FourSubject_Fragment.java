 ...
 */
public class FourSubject_Fragment extends BaseFragment implements PullDownScrollView.RefreshListener {

    private static final String tag = "FourSubject_Fragment";
...
//        setTime();
    ...
    @OnClick({R.id.id_orderexercise, R.id.id_randomexercise, R.id.id_specialexercise, R.id.id_notDone,
            ...
            R.id.id_selfculture, R.id.id_myError, R.id.id_myCollect, R.id.id_roadSign, R.id.id_Law, R.id.id_SharedBtn, R.id.id_shixueImg, R.id.id_shijiaImg})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.id_specialexercise:
                ...
                intent3.putExtra("ChapterListType", 4);
...
//                intent6.putExtra("Number", fromTextView(idRoadNum));
                intent6.putExtra("T_Subject", "8ABF4723-AA8A-4C44-8070-37D69F7CF16A");
            ...
            case R.id.id_Law:
                ...
                intent7.putExtra("T_Subject", "6238285B-3EEF-40EF-8AC7-F9B2E4D09A83");
    ...
    public void httpRepost() {
        Resquest.getCarouselList(handler, 4);
        Resquest.getOneSubjectCount(handler2, 4, Uid);
        Resquest.getVideoList(handler3, 6, NormalUtils.setRandom(29), 3);
        Resquest.getNoviceList(handler4, 1, 4, 1);
    }
