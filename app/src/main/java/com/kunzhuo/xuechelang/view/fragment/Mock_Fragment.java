 ...
 */
public class Mock_Fragment extends BaseFragment implements View.OnClickListener, AdapterView.OnItemClickListener {
...
//        problemListview.setOnItemClickListener(this);
        System.out.println(Type + " Type" + pageNum + "  pageNum 项");
...
//        dialog.show();
        ...
        boolean flag = DefaultUtils.getSharedBoolean(getActivity(), DefaultUtils.ISFIRSTMOCK, DefaultUtils.ISFIRSTMOCKFLAG);
        ...
        Resquest.getTitleRecord_MNKS(handler, Type, Uid, ispostNum, pageNum, 1);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.multiselect_btn:
                ...
                Resquest.upTitleRecord_Edit(handler3, Type, Uid, title_Bean.getID(), c_ChooseValue);
                ...
                if (c_ChooseValue.equals(c_Value)) { // 正确
                    ...
                    EventBus.getDefault().post(
                            new RoardAnswer_Event(title_Bean.getID(), true));


                } else { // 错误

                    EventBus.getDefault().post(
                            new RoardAnswer_Event(title_Bean.getID(), false));

                    Resquest.addTitleError_Add(handler5, Type, Uid, title_Bean.getID());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (T_option.equals("单选")) {
            ...
            Resquest.upTitleRecord_Edit(handler4, Type, Uid, title_Bean.getID(), A_option);
...

        {
            ...
            Resquest.upTitleRecord_Edit(handler4, Type, Uid, title_Bean.getID(), answer_bean.getA_option());
        ...
        { //ACD
            ...
            if (!flagisEn) {
                if (!flagposition) {
                    id_resultlay.setBackgroundColor(Color.rgb(255, 255, 255)); // 背景变白色
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case Resquest.SUCCESS_MSG:
                    ...
                    try {
                        java.lang.reflect.Type type = new TypeToken<List<Answer_Bean>>() {
                        }.getType();
                        SimpleDataMapper mapper = new SimpleDataMapper(type);
            ...
            switch (msg.what) {
                case Resquest.SUCCESS_MSG:
                    ...
                    try {
                        ...
                        if (code.equals("0")) {
//                            ToastUtil.show(getActivity(), " 提交状态成功");
                        }
...
//            ToastUtil.show(getActivity(), srcUrl + " 图片地址");
    ...
    public void setQusSeeAnswer(TitleList_KM_Bean bean) {
        ...
        String doneAnswer = bean.getRecordOption(); // 已经做过的答案
        ...
        for (int j = 0; j < adapter.getCount(); j++) {
            ...
            if (T_option.equals("单选")) {
                ...
                if (doneAnswer.equals(A_option) && doneAnswer.equals(C_option)) { // 正确答案
                    idJudgeflag.setVisibility(View.VISIBLE);
                    idJudgeflag.setImageResource(R.drawable.pass);
                    idResultChoose.setVisibility(View.INVISIBLE);
                    idResultMsg.setTextColor(Color.rgb(42, 196, 22));
                ...
                if (doneAnswer.equals(A_option) && !doneAnswer.equals(C_option)) {
            ...
            {
                String A_value = answer_bean.getA_value();
                String A_option = answer_bean.getA_option(); // 正确的选项
                String exC_option = null;
                ...
                if (doneAnswer.equals(A_option) && A_value.equals(exC_option)) { // 正确
                ...
                if (doneAnswer.equals(A_option) && !A_value.equals(exC_option)) {
                ...
                for (int i = 0; i < str.length(); i++) {
                    ...
                    if (doneAnswer.contains(answer_bean.getA_option()) && answer_bean.getA_option().equals(option)) {
