 ...
 * @author Alan
 *         <p>
 *         com.kunzhuo.android.weitanr.widget.XCRoundImageView
 *         </p>
 */
...
public class XCRoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (drawable.getClass() == NinePatchDrawable.class)
			return;
		Bitmap b = null;// = ((BitmapDrawable) drawable).getBitmap();
		...
		Bitmap bitmap = b;// b.copy(Bitmap.Config.ARGB_8888, true);
		if (defaultWidth == 0) {
